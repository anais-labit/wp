...
// Ce script est un script jQuery Migrate v1.4.1 qui permet d'ajouter des fonctionnalités qui manquent dans les versions plus récentes de jQuery et qui sont utilisées par les anciennes versions de jQuery. Il aide également à identifier les parties du code qui doivent être mises à jour pour être compatibles avec les dernières versions de jQuery. Ce script affiche également des avertissements dans la console pour informer les développeurs des problèmes potentiels dans leur code et suggère des alternatives plus récentes et plus performantes.
